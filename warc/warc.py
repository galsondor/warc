...
from . import gzip2
from .utils import CaseInsensitiveDict, FilePart, CRLF, LF
...
class WARCRecord(object):
    ...
    def from_response(response):
        ...
        payload = status_line + CRLF + headers + CRLF + body
...
class WARCReader:
    ...
    def finish_reading_current_record(self):
        ...
        if self.current_payload:
            ...
            self.expect(self.current_payload.fileobj, CRLF)
            self.expect(self.current_payload.fileobj, CRLF)
            self.current_payload = None
